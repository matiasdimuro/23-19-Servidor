	...
	public void run() {
		...
		if (!Globales.datosPartida.terminada) {
			...
			if (!jugadorUno.controlador.puedeDisparar) {
				...
				if (tiempoMuertoDisparoJugUno >= jugadorUno.getArmamento()[jugadorUno.armaEnUso].getTiempoMuertoDisparo()) {
					tiempoMuertoDisparoJugUno = 0;
			...
			if (!jugadorDos.controlador.puedeDisparar) {
				...
				if (tiempoMuertoDisparoJugDos >= jugadorDos.getArmamento()[jugadorDos.armaEnUso].getTiempoMuertoDisparo()) {
